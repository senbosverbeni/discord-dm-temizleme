...
(function () {
    ...
    <div class="toolbar" style="position:fixed;top:0;left:0;right:0;padding:8px;background:#36393f;box-shadow: 0 1px 0 rgba(0,0,0,.2), 0 1.5px 0 rgba(0,0,0,.05), 0 2px 0 rgba(0,0,0,.05);">
        <div style="display:flex;flex-wrap:wrap;">
            <span>Token <a href="https://github.com/victornpb/deleteDiscordMessages/blob/master/help/authToken.md" title="Help">?</a> <button id="getToken">Otomatik</button><br>
                <input type="password" id="authToken" placeholder="Senin Token" autofocus>*<br>
                <span>ID <a href="https://github.com/victornpb/deleteDiscordMessages/blob/master/help/authorId.md" title="Help">?</a> <button id="getAuthor">Otomatik</button></span>
                <br><input id="authorId" type="text" placeholder="Senin ID" priv></span>
            <span>Sunucu/Kanal <a href="https://github.com/victornpb/deleteDiscordMessages/blob/master/help/channelId.md" title="Help">?</a>
                <button id="getGuildAndChannel">auto</button><br>
                <input id="guildId" type="text" placeholder="Server ID" priv><br>
                <input id="channelId" type="text" placeholder="Kanal ID" priv><br>
                <label><input id="includeNsfw" type="checkbox">Sapık Kanal</label><br><br>
                <label for="file"  title="Import list of channels from messages/index.json file"> Dosya Ekle: <span class="btn">...</span> <input id="file" type="file" accept="application/json,.json"></label>
            </span><br>
            <span>Tarihler <a href="https://github.com/victornpb/deleteDiscordMessages/blob/master/help/messageId.md" title="Help">?</a><br>
                <input id="minDate" type="datetime-local" title="Sonra" style="width:auto;"><br>
                <input id="maxDate" type="datetime-local" title="Önce" style="width:auto;"><br>
            ...
            <span>Mesaj Arama <a href="https://github.com/victornpb/deleteDiscordMessages/blob/master/help/filters.md" title="Help">?</a><br>
                <input id="content" type="text" placeholder="Mesajınızı yazın" priv><br>
                <label><input id="hasLink" type="checkbox">link dahil</label><br>
                <label><input id="hasFile" type="checkbox">dosya dahil</label><br>
                <label><input id="includePinned" type="checkbox">sabitlenen mesaj dahil</label>
            </span>
        </div>
        <hr>
        ...
        <button id="clear" style="width:80px;">Temizle logu</button>
        <label><input id="autoScroll" type="checkbox" checked>Tiki Kaldırma</label>
        <label title="Hide sensitive information for taking screenshots"><input id="redact" type="checkbox">Sakın tikleme</label>
